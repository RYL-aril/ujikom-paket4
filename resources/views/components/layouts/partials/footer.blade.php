        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm italic text-coffee">
                    ...
                    <li><a href="#" class="hover:text-ink transition-colors">Kategori Buku</a></li>
                    <li><a href="#" class="hover:text-ink transition-colors">Koleksi Terbaru</a></li>
                    <li><a href="#" class="hover:text-ink transition-colors">Paling Banyak Dibaca</a></li>
                </ul>
            </div>
            ...
            <div>
                <h4
                    ...
                    Layanan</h4>
                <ul class="space-y-4 text-sm italic text-coffee">
                <li><a href="#" class="hover:text-ink transition-colors">Masuk
                            Anggota</a></li>
                    <li><a href="#" class="hover:text-ink transition-colors">Pendaftaran Baru</a></li>
                    <li><a href="#" class="hover:text-ink transition-colors">Aturan
                            Peminjaman</a></li>
                    <li><a href="#" class="hover:text-ink transition-colors">Informasi Denda</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="text-sm italic text-coffee space-y-4">
                    <p class="flex items-start gap-3">
                        <x-lucide-map-pin class="w-5 h-5 text-sepia-edge" />
                        <span>Jl. Scriptoria No. 12, Kota Knowledge</span>
                    </p>
                    <p class="flex items-center gap-3">
                        <x-lucide-mail class="w-5 h-5 text-sepia-edge" />
                        <span>info@scriptoria.id</span>
                    </p>
                    <p class="flex items-center gap-3">
                        <x-lucide-phone class="w-5 h-5 text-sepia-edge" />
